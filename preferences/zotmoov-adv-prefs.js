...
class ZotMoovAdvancedPrefs {
    ...
    {
        let pullButton = document.getElementById('zotmoov-adv-settings-sync-pull');
        let pushButton = document.getElementById('zotmoov-adv-settings-sync-push');
    ...
    async syncPullFromGitHub()
    {
        ...
        const result = await Zotero.ZotMoov.Sync.pullFromGitHub({ refreshMenus: true });
