# ZotGit Custom Menu Items

Users have the ability to create their own custom menu items in ZotGit, appearing in the context menu when you right-click an item. They can be created in Advanced Options.
