# ZotGit Custom Wildcards

Users have the ability to create their own custom wildcards in ZotGit, replacing %1, %2, ..., %9. They can be created/edited in Advanced Options.
