# ZotGit Wildcard Formatting

ZotGit keeps many of the same wildcards that Zotfile has, as well as the conditional and or wildcard operators
...
- `/{%s}/{%y}{-%m}{-%r}/` can yield
    ...
    - "///" which is effectively "/" the base ZotGit directory
